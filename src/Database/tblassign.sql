...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2024 at 12:01 PM
...
(118, 'asd', 'asd', 'asd', 'asd', 'yCpsf1pYqRWBQzTNpaLviKuMupIvSewWI+IkjOq/fdw=', 'Admin', 'Active'),
(119, 'aya', 'aya', 'aya', 'aya', 'SJzV28cIx+VB3k182Rzm0PFhNXO3/FtA05Qsy5VVzzU=', 'User', 'Active'),
...
--
ALTER TABLE `tblassign`
  MODIFY `u_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
COMMIT;
